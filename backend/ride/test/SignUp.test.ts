...
test('Não deve criar uma conta se o nome for inválido', async function () {
  ...
  await expect(async () => await signup.execute(inputSignup)).rejects.toThrow(new Error('Invalid name'))
})
...
test('Não deve criar uma conta se o email for inválido', async function () {
  ...
  await expect(async () => await signup.execute(inputSignup)).rejects.toThrow(new Error('Invalid email'))
})
...
test('Não deve criar uma conta se o cpf for inválido', async function () {
  ...
  await expect(async () => await signup.execute(inputSignup)).rejects.toThrow(new Error('Invalid cpf'))
})
...
test('Não deve criar uma conta se o email for duplicado', async function () {
  ...
  await expect(async () => await signup.execute(inputSignup)).rejects.toThrow(new Error('Duplicated account'))
})
...
test('Não deve criar uma conta para o motorista com a placa inválida', async function () {
  ...
  await expect(async () => await signup.execute(inputSignup)).rejects.toThrow(new Error('Invalid car plate'))
})
